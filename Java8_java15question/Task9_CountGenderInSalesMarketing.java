...
public class Task9_CountGenderInSalesMarketing {
    public static void main(String[] args) {
        ...
        Map<String, Long> genderCount = empList.stream().filter(e -> e.getDepartment().equals("Finance")).collect(Collectors.groupingBy(Employee::getGender, Collectors.counting()));
