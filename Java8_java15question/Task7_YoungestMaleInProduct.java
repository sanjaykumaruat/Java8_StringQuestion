...
public class Task7_YoungestMaleInProduct {
    public static void main(String[] args) {
        ...
        Employee youngest = empList.stream().filter(e -> e.getGender().equals("Male") && e.getDepartment().equalsIgnoreCase("Finance")).min(Comparator.comparingInt(Employee::getAge)).get();
