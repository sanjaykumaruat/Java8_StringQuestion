...
public class Task14_DuplicateEmployeeNames {
    public static void main(String[] args) {
       ...
       // empList.stream().map(Employee::getName).filter(name -> !names.add(name)).forEach(System.out::println);
